                  ...
                  Column(
                    ...
                    children: [
                      ...
                      TextFormFieldLabel(
                        enabled: controller.enableEdit.value,
                        padding: const EdgeInsets.symmetric(horizontal: 0),
                        lebelText: 'Limit Value',
                        lebelFontColor: const Color(0xff1A1A1A),
                        borderRadius: BorderRadius.circular(10.0),
                        hint: 'Limit Value',
                        controller: controller.limitValueController,
                        // focusNode: signupVM.lastNameFocusNode.value,
                        validating: (value) {
                          if (value!.isEmpty) {
                      ...
                      TextFormFieldLabel(
                        enabled: controller.enableEdit.value,
                        padding: const EdgeInsets.symmetric(horizontal: 0),
                        lebelText: 'Position Value',
                        lebelFontColor: const Color(0xff1A1A1A),
                        borderRadius: BorderRadius.circular(10.0),
                        hint: 'Position Value',
                        controller: controller.positionValueController,
                        // focusNode: signupVM.lastNameFocusNode.value,
                        validating: (value) {
                          if (value!.isEmpty) {
                            return 'Enter position value';
                          }
                          return null;
                        },
                        textCapitalization: TextCapitalization.none,
                      ...
                      TextFormFieldLabel(
                        enabled: controller.enableEdit.value,
                        padding: const EdgeInsets.symmetric(horizontal: 0),
                        lebelText: 'Complete Account Profit',
                        lebelFontColor: const Color(0xff1A1A1A),
                        borderRadius: BorderRadius.circular(10.0),
                        hint: 'Complete Account Profit',
                        controller: controller.completeProfitController,
                        // focusNode: signupVM.lastNameFocusNode.value,
                        validating: (value) {
                          if (value!.isEmpty) {
                            return 'Enter complete account profit';
                          }
                          return null;
                        },
                        textCapitalization: TextCapitalization.none,
                      ...
                      TextFormFieldLabel(
                        enabled: controller.enableEdit.value,
                        padding: const EdgeInsets.symmetric(horizontal: 0),
                        lebelText: 'Complete Account Loss',
                        lebelFontColor: const Color(0xff1A1A1A),
                        borderRadius: BorderRadius.circular(10.0),
                        hint: 'Complete Account Loss',
                        controller: controller.completeLossController,
                        // focusNode: signupVM.lastNameFocusNode.value,
                        validating: (value) {
                          if (value!.isEmpty) {
                            return 'Complete account loss';
                          }
                          return null;
                        },
                        textCapitalization: TextCapitalization.none,
